...
| ----------- | --------- | -------------------------------------------------- |
| **Epoch-E** | Endurance | Conservative, reliable. _"She'll outlast us all."_ |
| **Epoch-S** | Standard  | Balanced, sensible. _"The workhorse."_             |
| **Epoch-R** | Rapid     | Pushed to the limits. _"Running hot."_             |
...
-   _"Running hot, scanning everything, burning through cores like fuel."_
...
-   _"Slow and steady. She'll still be running when your Epoch-R is space junk."_
...
Power is not something players allocate or configure mid-flight. Ship configuration (what core you have, what systems are installed) determines capabilities. Players make decisions about _actions_ ("Do I scan now or wait?"), not _settings_ ("Allocate 40% to sensors").
