...
1. **Mods are not buffs.** Experience makes a component better at what it already does (paired with a nerf). Mods change *how* the component works — they shift behavior, unlock capability, or alter tradeoffs. A correlator doesn't make your sensor "stronger." It changes what information your sensor extracts from the same signal.
