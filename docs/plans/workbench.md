...
The shared fixtures test _behavior_: "Given a ship with this state and this loadout, `getCurrentPower()` at this timestamp returns this value." Both implementations can be structured however they want internally. The contract is the input/output pair.
