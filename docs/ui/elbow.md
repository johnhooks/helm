...
```html
<div class="lcars-elbow lcars-elbow--top-left lcars-elbow--orange lcars-elbow--md">
  <!-- Horizontal bar with outer rounded corner and inner sweep -->
  <div class="lcars-elbow__bar">
    <svg class="lcars-elbow__sweep" viewBox="0 0 1 1"
...
.lcars-elbow {
  ...
  --lcars-elbow-radius: var(--lcars-bar-height);           /* 32px - inner sweep radius */
  --lcars-elbow-outer-radius: 50%;                         /* outer cap radius */
  --lcars-elbow-gap: var(--lcars-space-1);                 /* 8px gap between sweep and buttons */
}
```
