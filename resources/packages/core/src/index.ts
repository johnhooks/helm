 ...
 *
 * Re-exports everything from data, errors, and logger so consumers
 * can import from a single package and the dependency extraction
 * plugin maps them all to one WordPress script handle.
 *
