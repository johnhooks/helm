		...
		>
			<div>
				...
				<Panel variant="default">
					<div style={{ color: '#ccc' }}>
						Simple dark container with rounded corners
					</div>
				</Panel>
			</div>
			...
			<div>
				...
				<Panel variant="bordered" tone="gold">
					<div style={{ color: '#ccc' }}>
						Adds a subtle border accent with glow
					</div>
				</Panel>
			</div>
			...
			<div>
				...
				<Panel variant="inset">
					<div style={{ color: '#ccc' }}>
						Recessed appearance for nested panels
					</div>
				</Panel>
			</div>
			...
			<div>
				...
				<Panel variant="bracket" tone="sky">
					<div style={{ color: '#ccc' }}>
						Vertical bars on sides like holding brackets
					</div>
				</Panel>
			</div>
		</div>
	...
	render: () => (
		<Panel variant="bordered" tone="danger" padding="lg">
			...
			<div style={{ color: '#ccc', lineHeight: 1.6 }}>
				Hull breach detected in section 14. Emergency forcefields are
				holding. Recommend immediate evacuation of affected areas.
			</div>
		</Panel>
	),
};
