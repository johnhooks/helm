...
export const TimeFormats: Story = {
	...
	render: () => (
		<div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
			<Countdown label="Days" remaining={172800} tone="gold" />{' '}
			{/* 2 days */}
			<Countdown label="Hours" remaining={16320} tone="sky" />{' '}
			{/* 4h 32m */}
			<Countdown label="Minutes" remaining={540} tone="lilac" />{' '}
			{/* 9m */}
			<Countdown label="Seconds" remaining={45} tone="orange" />{' '}
			{/* 45s */}
			...
			<Panel variant="default" padding="lg">
				...
				<div style={{ display: 'flex', gap: 32, marginBottom: 24 }}>
					<Countdown
						...
						active
						indicator={
							<ArcIndicator level={32} size="2xl" tone="sky" />
						}
					/>
					<div
						style={{
			...
			<Panel variant="default" padding="lg">
				...
				>
					<Countdown
						...
						active
						indicator={
							<ArcIndicator level={32} size="xl" tone="sky" />
						}
					/>
					<Countdown
						label="Scan"
						...
						active
						indicator={
							<ArcIndicator level={44} size="xl" tone="lilac" />
						}
					/>
					<Countdown
						label="Repair"
						...
						active
						indicator={
							<ArcIndicator level={75} size="xl" tone="orange" />
						}
					/>
				</div>
			</Panel>
