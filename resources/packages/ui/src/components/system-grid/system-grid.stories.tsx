...
export const Default: Story = {
	...
	render: () => (
		<SystemGrid columns={2}>
			<SystemCell
				indicator={<ArcIndicator level={85} size="lg" tone="accent" />}
			>
				<Readout
					label="Power"
					value={85}
			...
			<SystemCell
				indicator={<ArcIndicator level={42} size="lg" tone="accent" />}
			>
				<Readout
					label="Shields"
					value={42}
		...
		>
			...
			<SystemGrid columns={4} gap="lg">
				<SystemCell
					layout="column"
					indicator={
						<ArcIndicator level={85} size="2xl" tone="gold" />
					}
				>
					<Readout
						label="Power"
				...
				<SystemCell
					layout="column"
					indicator={
						<ArcIndicator level={100} size="2xl" tone="sky" />
					}
				>
					<Readout
						label="Shields"
				...
				<SystemCell
					layout="column"
					indicator={
						<ArcIndicator level={100} size="2xl" tone="accent" />
					}
				>
					<Readout
						label="Hull"
				...
				<SystemCell
					layout="column"
					indicator={
						<ArcIndicator level={98} size="2xl" tone="lilac" />
					}
				>
					<Readout
						label="Life"
	...
	render: () => (
		...
		>
			...
			<SystemGrid columns={2} gap="lg">
				<SystemCell
					indicator={
						<ArcIndicator level={23} size="xl" tone="orange" />
					}
				>
					<Readout
				...
				<SystemCell
					indicator={
						<ArcIndicator level={0} size="xl" tone="orange" />
					}
				>
				...
				<SystemCell
					indicator={
						<ArcIndicator level={45} size="xl" tone="gold" />
					}
				>
					<Readout
						label="Warp Core"
				...
				<SystemCell
					indicator={
						<ArcIndicator level={17} size="xl" tone="orange" />
					}
				>
					<Readout
						label="Torpedoes"
			...
			>
				...
				<div style={{ fontSize: 13, color: '#ccc', lineHeight: 1.5 }}>
					Hull breach detected in sections 12-14. Emergency
					forcefields active. Recommend immediate withdrawal from
					combat.
				</div>
			</div>
		</div>
