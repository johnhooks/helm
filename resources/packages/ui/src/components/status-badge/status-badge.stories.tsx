...
export const Sizes: Story = {
  ...
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
      ...
      <StatusBadge size="md" tone="success">Medium</StatusBadge>
    </div>
  ),
};
...
export const Pulsing: Story = {
  ...
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
      ...
      <StatusBadge tone="info" pulse>Scanning</StatusBadge>
      <StatusBadge tone="warning" pulse>Low Power</StatusBadge>
  ...
  render: () => (
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
        <span style={{ color: "#a39a88", fontSize: 10, letterSpacing: "0.1em" }}>
          WARP CORE
        </span>
        <StatusBadge tone="success">Online</StatusBadge>
      </div>
