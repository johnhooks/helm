...
export const AllStates: Story = {
  ...
  render: () => (
    <div style={{ display: "flex", gap: 24, flexWrap: "wrap", alignItems: "flex-start" }}>
      <div>
        <div style={{ fontFamily: "var(--helm-ui-font-family)", fontSize: 9, letterSpacing: "0.1em", color: "#444", textTransform: "uppercase", marginBottom: 8 }}>
          Unscanned
        </div>
        <ContextMenu
          name="Tau Ceti"
      ...
      <div>
        ...
        <ContextMenu
          ...
          actions={[
            { label: "Rescan Route", detail: "1h 12m" },
            { label: "Jump", detail: "4d 2h · 32% fuel", tone: "accent" },
          ]}
        />
      </div>
      <div>
...
const LABEL: CSSProperties = { fontFamily: '"Antonio", sans-serif', fontSize: 9, letterSpacing: "0.1em", color: "#444", textTransform: "uppercase", marginBottom: 6 };
  ...
  render: () => (
    <div style={DOC}>
      ...
      <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 11 }}>
        ...
        <tbody>
          {[
            ...
            ["tone", "Tone", "Color for the header name (sky, accent, lilac, gold, orange, danger, neutral)"],
            ["actions", "ContextMenuAction[]", "List of available actions"],
      ...
      <p style={{ ...P, marginTop: 8 }}>
        Each <code style={CODE}>ContextMenuAction</code> has: <code style={CODE}>label</code> (string),{" "}
      ...
      <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
        ...
        <li style={LI}>Keyboard nav: Arrow Up/Down, Home/End between enabled items; Enter/Space triggers</li>
        <li style={LI}>Uses <code style={CODE}>role=&quot;menu&quot;</code> / <code style={CODE}>role=&quot;menuitem&quot;</code> for a11y</li>
      ...
      <div style={{ display: "flex", gap: 16, flexWrap: "wrap", marginTop: 12 }}>
        <div>
          ...
          <ContextMenu name="Tau Ceti" subtitle="G8.5V · 11.9 ly" tone="sky" actions={[{ label: "Scan Route", detail: "1h 12m" }, { label: "Jump", detail: "route unknown", disabled: true }]} />
        </div>
        <div>
          <div style={LABEL}>Scanned</div>
          <ContextMenu name="Tau Ceti" subtitle="G8.5V · 11.9 ly" tone="sky" actions={[{ label: "Rescan Route", detail: "1h 12m" }, { label: "Jump", detail: "4d 2h", tone: "accent" }]} />
        </div>
        <div>
          <div style={LABEL}>Current System</div>
          <ContextMenu name="Sol" subtitle="G2V · current" tone="accent" actions={[{ label: "Survey", detail: "8 planets" }, { label: "Dock", detail: "Sol Station" }]} />
        </div>
        <div>
          <div style={LABEL}>Planet</div>
          <ContextMenu name="Jupiter" subtitle="Gas Giant" tone="lilac" actions={[{ label: "Scan Planet", detail: "2h 40m" }, { label: "Survey Moons", detail: "4h" }]} />
        </div>
      </div>
    </div>
  ),
