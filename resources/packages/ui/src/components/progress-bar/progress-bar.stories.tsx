      ...
      <Panel variant="default" padding="lg">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          <div>
            ...
            <ProgressBar value={67} tone="sky" size="lg" label="Jump progress" active />
          </div>

          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 16 }}>
            <Readout label="Distance" value={11.9} unit="LY" tone="sky" size="sm" />
            <Readout label="Remaining" value={3.9} unit="LY" tone="sky" size="sm" />
          </div>
        </div>
      </Panel>
    </div>
    ...
    <div style={{ minWidth: 400 }}>
      <Panel variant="bracket" tone="lilac" padding="md">
        <div style={{ marginBottom: 16 }}>
          ...
          <div style={{ fontSize: 12, color: "#666" }}>Sector 7G — Anomaly detected</div>
        </div>
        <ProgressBar value={42} tone="lilac" size="md" showValue label="Scan progress" />
      </Panel>
    </div>
  ),
};
    ...
    <div style={{ minWidth: 400 }}>
      <Panel variant="default" padding="lg">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div>
            <div style={{ fontSize: 10, color: "#666", marginBottom: 6, fontFamily: "Antonio, sans-serif", letterSpacing: "0.1em" }}>
              PORT SHIELD EMITTER
            </div>
            <ProgressBar value={78} tone="orange" size="md" showValue label="Repair progress" />
          </div>
          <div>
            <div style={{ fontSize: 10, color: "#666", marginBottom: 6, fontFamily: "Antonio, sans-serif", letterSpacing: "0.1em" }}>
              HULL SECTION 14
            </div>
            <ProgressBar value={23} tone="danger" size="md" showValue label="Repair progress" />
          </div>
          <div>
            <div style={{ fontSize: 10, color: "#666", marginBottom: 6, fontFamily: "Antonio, sans-serif", letterSpacing: "0.1em" }}>
              TARGETING ARRAY
            </div>
            <ProgressBar value={100} tone="success" size="md" showValue label="Repair complete" />
          </div>
        </div>
      </Panel>
    </div>
...
export const MultipleOperations: Story = {
  ...
  render: () => (
    <div style={{ minWidth: 450 }}>
      <Panel variant="default" padding="lg">
        <TitleBar title="Operations" subtitle="Active Tasks" tone="gold" />

        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
              <span style={{ fontSize: 11, color: "#ccc", fontFamily: "Antonio, sans-serif", letterSpacing: "0.05em" }}>
                JUMP TO TAU CETI
              </span>
              <span style={{ fontSize: 10, color: "#666" }}>4h 32m remaining</span>
            </div>
          ...
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
              ...
              <span style={{ fontSize: 10, color: "#666" }}>2h 15m remaining</span>
            </div>
          ...
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
              ...
              <span style={{ fontSize: 10, color: "#666" }}>45m remaining</span>
            </div>
            <ProgressBar value={78} tone="orange" size="sm" active />
          </div>
          ...
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
              ...
              <span style={{ fontSize: 10, color: "#666" }}>Processing...</span>
            </div>
            <ProgressBar value={0} tone="gold" size="sm" indeterminate />
          </div>
        </div>
      </Panel>
    </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
          ...
          >
            ...
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: 10, color: "#666", fontFamily: "Antonio, sans-serif", letterSpacing: "0.1em" }}>
                JUMP
              </div>
              <div style={{ fontSize: 18, fontWeight: 700, color: "var(--helm-ui-color-sky)" }}>67%</div>
              <div style={{ fontSize: 10, color: "#666" }}>4h 32m</div>
            </div>
          </div>
          ...
          >
            <StackIndicator level={42} segments={5} size="2xl" tone="lilac" />
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: 10, color: "#666", fontFamily: "Antonio, sans-serif", letterSpacing: "0.1em" }}>
                SCAN
              </div>
              <div style={{ fontSize: 18, fontWeight: 700, color: "var(--helm-ui-color-lilac)" }}>42%</div>
              <div style={{ fontSize: 10, color: "#666" }}>2h 15m</div>
            </div>
          </div>
          ...
          >
            ...
            <div style={{ textAlign: "center" }}>
              ...
              <div style={{ fontSize: 18, fontWeight: 700, color: "var(--helm-ui-color-orange)" }}>78%</div>
              <div style={{ fontSize: 10, color: "#666" }}>45m</div>
            </div>
          </div>
        </div>
      </Panel>
