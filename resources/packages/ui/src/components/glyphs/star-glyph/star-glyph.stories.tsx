			...
			>
				...
				{(
					[
						...
						{ class: "F", temp: "6,000-7,500K", color: "Yellow-white" },
	...
	render: () => (
		<Panel variant="inset" padding="lg" style={{ minWidth: 400 }}>
			<div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
				{(
					[
						{ type: "mainSequence", label: "Main Sequence", desc: "Normal star" },
						{ type: "giant", label: "Giant", desc: "Expanded, luminous" },
						{ type: "whiteDwarf", label: "White Dwarf", desc: "Dead star core" },
						{ type: "neutron", label: "Neutron Star", desc: "Collapsed core" },
						{ type: "pulsar", label: "Pulsar", desc: "Rotating neutron star" },
						{ type: "brownDwarf", label: "Brown Dwarf", desc: "Failed star" },
					] as const
				).map((star) => (
					<div
						key={star.type}
...
const spectralSizeMap: Record<SpectralClass, "xxs" | "xs" | "sm" | "md" | "lg" | "xl" | "xxl"> = {
	M: "xs",
	K: "sm",
	G: "md",
	F: "md",
...
export const StellarNeighborhood: Story = {
	...
	render: () => {
		const stars: Array<{
			...
			{ name: "Sol", spectralClass: "G", stellarType: "mainSequence", distance: "0 LY" },
			{ name: "Alpha Centauri A", spectralClass: "G", stellarType: "mainSequence", distance: "4.37 LY" },
			{ name: "Alpha Centauri B", spectralClass: "K", stellarType: "mainSequence", distance: "4.37 LY" },
			{ name: "Proxima Centauri", spectralClass: "M", stellarType: "mainSequence", distance: "4.24 LY" },
			{ name: "Barnard's Star", spectralClass: "M", stellarType: "mainSequence", distance: "5.96 LY" },
			{ name: "Sirius A", spectralClass: "A", stellarType: "mainSequence", distance: "8.6 LY" },
			{ name: "Sirius B", spectralClass: "A", stellarType: "whiteDwarf", distance: "8.6 LY" },
			{ name: "Vega", spectralClass: "A", stellarType: "mainSequence", distance: "25 LY" },
		];

		return (
			<Panel variant="default" padding="lg" style={{ minWidth: 600 }}>
				<TitleBar title="Local Stellar Neighborhood" subtitle="Within 30 LY" tone="gold">
...
export const ExoticSystem: Story = {
	...
	render: () => (
		<Panel variant="bordered" tone="violet" padding="lg" style={{ minWidth: 500 }}>
			...
			>
				Binary pulsar system. Extreme gravitational effects. Recommended approach
				vector: none. Observation distance: 2+ LY minimum.
			</div>
		</Panel>
	),
};
