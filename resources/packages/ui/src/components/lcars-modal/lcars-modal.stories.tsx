		...
		return (
			<>
				...
				>
					...
					>
						<p style={{ margin: 0 }}>
							Initiate warp jump to the following destination?
						</p>
						<div
							style={{
								display: 'flex',
			...
			<>
				...
				>
					...
					>
						...
						<p style={{ margin: 0 }}>
							Raise shields and arm weapons? This will alert
							nearby vessels to your defensive posture.
						</p>
					</div>
				</LcarsModal>
			</>
...
export const Sizes: Story = {
	...
	render: function SizesDemo() {
		...
		const content = (
			<p style={{ margin: 0 }}>
				This modal demonstrates different size variants. The content
				area adjusts to fit the modal width.
			</p>
		);
					...
					(tone) =>
						openTone === tone && (
							<LcarsModal
								...
								footer={
									<Button onClick={() => setOpenTone(null)}>
										Close
									</Button>
								}
							>
								<p style={{ margin: 0 }}>
									This is a {tone} toned modal.
								</p>
							</LcarsModal>
						)
				)}
	...
	render: function NoFooterModal() {
		...
		return (
			<>
				...
				>
					<p style={{ margin: 0 }}>
						This modal has no footer. Click the X or press Escape to
						close.
					</p>
				</LcarsModal>
			</>
