...
trait WpunitTesterActions
{
     ...
     * @see \Tests\Support\Helper\Helm::haveOrigin()
     */
    public function haveOrigin(string $id = "test-origin", string $seed = "test-seed"): \Helm\Origin\OriginConfig {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveOrigin', func_get_args()));
    }
     ...
     * @see \Tests\Support\Helper\Helm::haveStar()
     */
    public function haveStar(array $attributes = []): \Helm\Stars\StarPost {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveStar', func_get_args()));
    }
     ...
     * @see \Tests\Support\Helper\Helm::haveStars()
     */
    public function haveStars(int $count, array $attributes = []): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveStars', func_get_args()));
    }
     ...
     * @see \Tests\Support\Helper\Helm::havePlanet()
     */
    public function havePlanet(int $starPostId, array $attributes = []): \Helm\Planets\PlanetPost {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('havePlanet', func_get_args()));
    }
     ...
     * @see \Tests\Support\Helper\Helm::havePlanets()
     */
    public function havePlanets(int $starPostId, int $count, array $attributes = []): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('havePlanets', func_get_args()));
    }
    ...
    public function haveShips(int $count, array $attributes = []): array {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('haveShips', func_get_args()));
    }
     ...
     *
     * Get a star by ID.
     * @see \Tests\Support\Helper\Helm::grabStar()
     */
    public function grabStar(string $id): ?\Helm\Stars\StarPost {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('grabStar', func_get_args()));
    }
     ...
     * @see \Tests\Support\Helper\Helm::seeStarInDatabase()
     */
    public function seeStarInDatabase(string $id): void {
        $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeStarInDatabase', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Tests\Support\Helper\Helm::seeStarInDatabase()
     */
    public function canSeeStarInDatabase(string $id): void {
        $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeStarInDatabase', func_get_args()));
    }
     ...
     * @see \Tests\Support\Helper\Helm::dontSeeStarInDatabase()
     */
    public function dontSeeStarInDatabase(string $id): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('dontSeeStarInDatabase', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Tests\Support\Helper\Helm::dontSeeStarInDatabase()
     */
    public function cantSeeStarInDatabase(string $id): void {
        $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('dontSeeStarInDatabase', func_get_args()));
    }
     ...
     * @see \Tests\Support\Helper\Helm::seeShipInDatabase()
     */
    public function seeShipInDatabase(string $id): void {
        $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeShipInDatabase', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Tests\Support\Helper\Helm::seeShipInDatabase()
     */
    public function canSeeShipInDatabase(string $id): void {
        $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeShipInDatabase', func_get_args()));
    }
     ...
     * @see \Tests\Support\Helper\Helm::dontSeeShipInDatabase()
     */
    public function dontSeeShipInDatabase(string $id): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('dontSeeShipInDatabase', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Tests\Support\Helper\Helm::dontSeeShipInDatabase()
     */
    public function cantSeeShipInDatabase(string $id): void {
        $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('dontSeeShipInDatabase', func_get_args()));
    }
}
